...
- **Fonts** — already set to **Inter** (display) / **Hanken Grotesk** (body); ignore any preset font name lingering in prose.
...
```html
<style>
@font-face{font-family:"Hanken Grotesk";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/HankenGrotesk-Regular.woff2") format("woff2");}
@font-face{font-family:"Hanken Grotesk";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/HankenGrotesk-Regular.woff") format("woff");}
...
@font-face{font-family:"Material Symbols";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/MaterialSymbols-Regular.woff") format("woff");}
@font-face{font-family:"Material Symbols";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/MaterialSymbols-Regular.woff2") format("woff2");}
@font-face{font-family:"Noto Sans TC";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/NotoSansTC-Regular.woff") format("woff");}
@font-face{font-family:"Noto Sans TC";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/NotoSansTC-Regular.woff2") format("woff2");}
</style>
```
