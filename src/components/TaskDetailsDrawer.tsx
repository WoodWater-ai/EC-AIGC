...
import { GeneratedImageResult, GenerationTask, ImageRevisionContext, ProductAsset, ResultReviewStage, VideoTaskEntryContext, IMAGE_GENERATION_TYPE_LABELS } from '../types';
...
export const TaskDetailsDrawer: React.FC<TaskDetailsDrawerProps> = ({ tasks, products, initialTaskId, onClose, onUpdateTask, onCreateVideo }) => {
